...
Route::get('/post/edit/{id}', [BlogController::class, 'PostEdit'])->name('post.edit');
Route::post('/post/update', [BlogController::class, 'PostUpdate'])->name('post-update');
Route::post('/image/update', [BlogController::class, 'PostImageUpdate'])->name('update-post-image');
