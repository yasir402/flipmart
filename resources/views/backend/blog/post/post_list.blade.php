      ...
      <div class="col-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Blog Post List <span class="badge badge-pill badge-danger"> {{ count($blogpost) }} </span>
            </h3>
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody> @foreach($blogpost as $item) <tr>
                    ...
                    <td width="20%">
                      <a href="{{ route('post.edit',$item->id) }}" class="btn btn-info" title="Edit Data">
