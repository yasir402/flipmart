...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
  <div class="container">
    ...
    @endforeach
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          ...
                          $discount = ($amount/(int)$product->selling_price) * 100; 
                          @endphp
                          
                         <div>
                       @if ((int)$product->discount_price == NULL)
        ...
        <!-- ==============================================skip_product_0 FEATURED PRODUCTS ============================================== -->
        <section class="section featured-product wow fadeInUp">
        ...
        <!-- /.section --> 
        <!-- ==============================================skip_product_0 FEATURED PRODUCTS : END ============================================== --> 




 <!-- ==============================================skip_product_1 FEATURED PRODUCTS ============================================== -->
        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
        ...
        <!-- /.section --> 
        <!-- ==============================================skip_product_1 FEATURED PRODUCTS : END ============================================== --> 
        ...
        <!-- ============================================== WIDE PRODUCTS : END ============================================== --> 
         ...
         <!-- ============================================== skip_brand_product_1 FEATURED PRODUCTS ============================================== -->
        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
...
<div class="products">
  ...
  <!-- /.product --> 
        ...
        <!-- /.section --> 
        <!-- ==============================================skip_brand_product_1 FEATURED PRODUCTS : END ============================================== --> 
