  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Flip Mart</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Flip Mart Head Office
               Email:saifalisiddique1598@gmail.com <br>
               Mob: 03172170165 <br>
               Karachi 79800,Orangi Town:#9 <br>
